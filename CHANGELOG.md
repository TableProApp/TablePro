...
- Query results can be drawn as native bar, line, area and scatter charts from the loaded rows. Charts offer typed axis and series controls, report skipped values and warn when more rows remain to be fetched. This is a Starter feature.
