...
public enum RelayFDState: Equatable, Sendable {
    case idle
    case readable
    case drainThenStop
    case stop
...
public func relayFDState(_ revents: Int16) -> RelayFDState {
...
public enum TransportPollOutcome: Equatable, Sendable {
    case ready
    case timedOut
    case hangup
}

public func transportPollOutcome(revents: Int16, requestedEvents: Int16) -> TransportPollOutcome {
...
/// zero-yield spin.
public func pollReady(fd: Int32, directions: RelayDirections, timeoutMs: Int32) -> Bool {
    var events: Int16 = 0
