//
//  CloudflareD1DefaultValue.swift
...
internal func cloudflareD1DefaultValueFromCatalog(_ value: String?) -> String? {
    ...
    if upper == "NULL" || upper == "TRUE" || upper == "FALSE"
        ...
        || cloudflareD1WholeStringLiteral(value) != nil {
        return value
    }
    return cloudflareD1LooksLikeExpression(value) ? "(\(value))" : "'\(cloudflareD1DefaultLiteralEscape(value))'"
}

/// Whether the fragment is one whole single-quoted literal rather than an expression that happens
/// to start with a quote.
internal func cloudflareD1WholeStringLiteral(_ value: String) -> String? {
...
private let cloudflareD1ExpressionCharacters: Set<Character> = ["(", ")", "|", "+", "-", "*", "/", "%", "<", ">", "=", "!", "~", "&", " ", ","]

internal func cloudflareD1LooksLikeExpression(_ value: String) -> Bool {
    value.contains { cloudflareD1ExpressionCharacters.contains($0) }
}

internal func cloudflareD1DefaultLiteralEscape(_ value: String) -> String {
