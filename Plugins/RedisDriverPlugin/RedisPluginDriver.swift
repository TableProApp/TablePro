...
final class RedisPluginDriver: PluginDatabaseDriver, @unchecked Sendable {
    ...
    private func resolveDataPlaneAddress(sslConfig: SSLConfiguration) async throws -> (String, Int) {
    ...
    private func resolveSentinelMaster(sslConfig: SSLConfiguration) async throws -> (String, Int) {
