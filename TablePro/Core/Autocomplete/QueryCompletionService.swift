...
enum QueryCompletionServiceFactory {
    static func make(schemaProvider: SQLSchemaProvider?, databaseType: DatabaseType?) -> QueryCompletionService {
        ...
        default:
            return SQLCompletionService(schemaProvider: schemaProvider, databaseType: databaseType)
        }
    }
}
