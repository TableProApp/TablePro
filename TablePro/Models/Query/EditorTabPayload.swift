...
internal struct EditorTabPayload: Codable, Hashable {
    ...
    internal let sourceFileEncoding: FileTextEncoding?
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case forcesNewTab
        case tabTitle
        case initialFilterState, sourceFileURL, sourceFileStamp, sourceFileEncoding
        case erDiagramSchemaKey, objectRef, versionHistorySubject, intent
    ...
    internal func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(sourceFileEncoding, forKey: .sourceFileEncoding)
