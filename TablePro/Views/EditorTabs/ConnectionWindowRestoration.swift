//
//  ConnectionWindowRestoration.swift
//  TablePro
//
...
@MainActor
final class ConnectionWindowRestoration: NSObject, NSWindowRestoration {
    ...
    nonisolated static func restoreWindow(
        ...
        Task { @MainActor in
            ...
            if let restored {
                ...
                logger.error("[restore] WindowManager opened connection window but no window found")
