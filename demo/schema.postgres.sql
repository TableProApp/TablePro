-- Schema for the screenshots on tablepro.app. Table and column names are load
-- bearing: the marketing copy names them, so renaming one here silently makes a
-- sentence on the site wrong.
