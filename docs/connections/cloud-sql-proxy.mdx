...
The proxy runs as a child process of the app, started on connect and killed on disconnect. What it needs from you is the instance connection name, `project:region:instance`, on the instance's overview page in the Google Cloud console.
