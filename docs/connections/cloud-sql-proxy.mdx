...
<Frame caption="Cloud SQL Auth Proxy selected on the Network tab">
  <img className="block dark:hidden" src="/images/cloud-sql-proxy-pane.png" alt="Instance connection name, authentication and local listener fields" />
  <img className="hidden dark:block" src="/images/cloud-sql-proxy-pane-dark.png" alt="Instance connection name, authentication and local listener fields" />
</Frame>
