...
| **Outside MCP Servers** | Servers this connection's Assistant sessions may call. Add them under Settings > Integrations first. A connection with none ticked has no outside tools. See [MCP Server](/features/mcp#calling-an-outside-server) |
