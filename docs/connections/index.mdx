...
| **Recent** | The five connections you opened last, favorites left out. It appears by default in the welcome window and **Switch Connection**; turn off **Settings > General > Connections > Show recent connections** to hide it without clearing the history. Right-click one for **Remove from Recent**, or the section header for **Clear Recent** |
...
The sort order and recent-connection history stay on this Mac. The visibility choice is a synced General setting between Macs; [iPhone and iPad skip app settings](/features/icloud-sync#what-syncs).
