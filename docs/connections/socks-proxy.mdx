...
When the database is only reachable through a corporate proxy, a bastion running `ssh -D`, or another SOCKS5 endpoint, the **SOCKS Proxy** pane in the connection form is the way in.
