...
Deleting a profile leaves the connections that used it pointing at nothing. Each shows **Selected SSH profile no longer exists.** under **SSH Tunnel**, with a **Switch to Inline Configuration** button, until it is given a tunnel config again.
