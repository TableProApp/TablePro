...
| Setting | Default | Description |
|---------|---------|-------------|
| **Show workspace rail** | On | Adds a narrow strip on the window's leading edge listing every connection and database you have open, so one click switches to it |
