...
<CardGroup cols={2}>
  <Card title="General" icon="gear" href="/customization/general-settings">Language, startup, tabs, connections, sidebar, query timeout, updates, reset.</Card>
  ...
  <Card title="Profiles" icon="id-card" href="/connections/credential-profiles">Credential profiles and SSH servers, and which connections use each.</Card>
...
| Editor | Show invisible characters | On |
| Editor | Tab width | 4 spaces |
| Editor | Keyword case | Match what I type, otherwise UPPERCASE |
