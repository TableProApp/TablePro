...
Install `rledger` or Python Beancount before you connect. The plugin shells out to one of those two and projects the answer into 21 read-only SQL tables.
...
- Directives outside the 21 tables are not projected. They stay in the source files.
