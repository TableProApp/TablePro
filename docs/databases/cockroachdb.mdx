...
**Schemas**: like PostgreSQL, default schema `public`. The toolbar shows the active database and schema side by side; click either to switch it, or press Cmd+K for the database list. Database > Schema does the same job from the menu bar.
