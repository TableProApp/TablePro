...
description: All 33 engines TablePro connects to, their default ports, and which ones need a plugin
---

import DriverCounts from "/snippets/driver-counts.mdx";

Thirty-three engines, and every one of them is free to use. What differs between them is where the
...
also run on the bundled MySQL driver.
