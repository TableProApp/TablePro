...
description: All 36 engines TablePro connects to, their default ports, and which ones need a plugin
---

import DriverCounts from "/snippets/driver-counts.mdx";

Thirty-six engines, and every one of them is free to use. What differs between them is where the
...
| [Cloudflare R2 SQL](/databases/cloudflare-r2-sql) | API-based | Plugin |
| [CockroachDB](/databases/cockroachdb) | 26257 | Built-in |
| [Dameng DM8](/databases/dameng) | 5236 | Plugin |
| [Databend](/databases/databend) | 3307 | Built-in |
...
| [OceanBase](/databases/oceanbase) | 2881 | Built-in |
...
| [Spanner](/databases/spanner) | API-based | Plugin |
...
| [TiDB](/databases/tidb) | 4000 | Built-in |
...
and Redshift, CockroachDB and PGlite all speak the PostgreSQL wire protocol. TiDB, Databend and
OceanBase also run on the bundled MySQL driver.
