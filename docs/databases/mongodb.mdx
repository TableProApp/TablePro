...
- A new row, duplicate or paste cannot hold a field named `__proto__`, or an empty field name at any depth: the save is refused. Set that cell to NULL, save, then set it on the saved document.
