...
**Autocomplete**: The editor suggests collections, methods, field names, and the `$` operators that are valid at the cursor. See [Autocomplete](/features/autocomplete#mongodb).
