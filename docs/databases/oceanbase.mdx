...
| **Database** | empty | Optional. Leave it empty and open one in the tenant with `Cmd+K` |
...
- External tables list as external tables, and system and virtual tables as system tables. All three are read-only kinds, so their menus drop **Truncate** and **Import**.
