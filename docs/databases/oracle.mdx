...
Install **Oracle Driver** from **Settings > Plugins > Browse**, or pick Oracle in the connection form and let it prompt you. That is the entire client install: the driver speaks TNS in pure Swift, so Instant Client and the rest of Oracle's stack stay off your Mac. Logins work against Oracle Database 11.1 and later, on-premises, in Docker, or in Oracle Cloud.
