...
**Schemas**: like PostgreSQL, default schema `public`. Pick the active schema from Database > Schema; the toolbar shows the active one. Cmd+K opens the database switcher, which on PGlite lists only `postgres`.
