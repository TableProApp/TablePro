...
<Warning>
**Skip TLS Verification**, a toggle in the Options tab, trusts any certificate even when the mode is **Verify CA** or **Verify Identity**. Leave it off outside a development server with a self-signed certificate.
</Warning>
