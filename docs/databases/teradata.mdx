...
| Logon Mechanism | The logon method. Default `TD2`. |
...
- **Logon fails.** Check the username, password, and that the account is not locked. LDAP and Kerberos logon are not yet supported; use `TD2`.
