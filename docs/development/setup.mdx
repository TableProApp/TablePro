...
ships in the macOS 26 SDK. The deployment target stays at macOS 13.0, which is what the built app
...
<Tree>
  ...
  <Tree.Folder name="Packages">
    <Tree.File name="TableProCore, TableProOracle, TableProEditor and TableProGrammars" />
  </Tree.Folder>
