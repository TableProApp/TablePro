...
Every request is recorded in the activity log. Open **Settings > MCP > Activity Log** to inspect.

## Quick start

- Install the [Raycast extension](/external-api/raycast) and run `Pair with TablePro`.
- Or wire stdio MCP into [Cursor or Claude Desktop](/external-api/cursor-claude) without an extension.
...
- [Cursor and Claude Desktop](/external-api/cursor-claude): stdio MCP setup.
