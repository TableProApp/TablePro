---
title: External API
description: URL scheme, AppleScript, MCP server, pairing flow, terminal, and iOS Shortcuts for driving TablePro from other apps
---

Deep links drive the GUI. MCP moves data. AppleScript does both and hands the answer back to the
script that asked. That split decides which page you need, and pairing is the step in front of MCP
that gets a client its token.
...
<CardGroup cols={2}>
  ...
  <Card title="AppleScript" icon="scroll" href="/external-api/applescript">
    A scripting dictionary for connections, tabs, results and queries.
  </Card>
