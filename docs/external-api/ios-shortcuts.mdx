...
| *"Open this connection in TablePro to check the server's SSH host key first."* | The SSH server is new, or its host key changed. A Shortcut has no screen to show the question on. |
