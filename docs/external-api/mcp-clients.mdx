...
**External Clients** on that connection is **Read Only** and the statement writes. Change it in the connection editor's **Options** section, or run the query in the app's editor.
