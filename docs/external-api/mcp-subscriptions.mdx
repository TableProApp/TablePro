...
description: subscriptions/listen, the notification filter TablePro honours, and what it deliberately does not send
---
...
## What TablePro honours

| Filter field | Honoured | Notes |
|--------------|:--------:|-------|
