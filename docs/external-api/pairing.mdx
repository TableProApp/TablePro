...
<Frame caption="Scope, connections and expiry are all editable before Approve">
  <img className="block dark:hidden" src="/images/mcp-pairing-approval-sheet.png" alt="Approval sheet headed Allow Raycast to access TablePro, with the delivery address, a permissions picker, a connection list and an expiry picker" />
  <img className="hidden dark:block" src="/images/mcp-pairing-approval-sheet-dark.png" alt="Approval sheet headed Allow Raycast to access TablePro, with the delivery address, a permissions picker, a connection list and an expiry picker" />
</Frame>
