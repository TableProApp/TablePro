...
Searching connections, browsing schemas, and running SQL all happen inside the Raycast window, without switching to the app. Nine commands and twelve AI tools reach TablePro through the `tablepro://` URL scheme and the [MCP server](/external-api/mcp-tools), after one pairing step. Requires TablePro 0.37.0 or later.
