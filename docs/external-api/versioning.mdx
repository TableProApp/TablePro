...
The MCP server reports `protocolVersion: "2025-03-26"` from `initialize`. That value comes from the [Model Context Protocol spec](https://modelcontextprotocol.io) and is independent of TablePro's app version.
