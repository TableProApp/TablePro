...
<DriverCounts /> The app download stays around 20 MB. Each one must match the SHA-256 checksum in the registry manifest and carry a valid code signature before it loads.
</Accordion>
