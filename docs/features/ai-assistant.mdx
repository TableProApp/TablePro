---
title: AI Assistant
description: "Built-in AI for SQL: chat with tool calling, inline suggestions, and review, explain, optimize, and fix-error across 14 providers"
---
...
Put the cursor in a statement, or select the part you want, then pick an action. Each one sends what **Run** would run, never the whole tab, and opens a new conversation.
...
<Frame caption="The chip lists the tables whose structure went with the request">
  <img className="block dark:hidden" src="/images/ai-query-review.png" alt="Query bar with the Review button, and the assistant answering a review of a JOIN" />
  <img className="hidden dark:block" src="/images/ai-query-review-dark.png" alt="Query bar with the Review button, and the assistant answering a review of a JOIN" />
</Frame>
