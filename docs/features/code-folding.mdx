...
Move the pointer into the gutter and a chevron appears beside every region that spans more than one line: whole statements, table bodies, CTEs, subqueries, `BEGIN` blocks, and block comments. Click to collapse, click again to expand.
