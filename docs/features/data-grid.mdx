...
Most of the grid's controls sit in the status bar beneath it: the view switcher at the leading edge, the row count in the middle, then the columns, filter and page buttons at the trailing edge.
