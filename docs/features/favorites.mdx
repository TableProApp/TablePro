...
The Favorites tab in the sidebar holds pinned databases and tables, saved SQL, a **Team Library** on a Team license, and any folders of `.sql` files you have linked.
