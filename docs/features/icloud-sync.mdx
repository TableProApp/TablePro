...
A localhost or throwaway database is rarely worth a round trip. Mark it **Local only** in the connection form's **Options** section, or right-click it and choose **Exclude from iCloud Sync**. They show a struck-through cloud icon in the connection list, and the flag survives duplicating and exporting.
