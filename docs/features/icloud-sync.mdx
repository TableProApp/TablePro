...
Sync is off by default, and it needs an active license, Starter or Team (see [Licensing](/features/licensing)). Every category has its own toggle, and individual connections can be marked **Local only**. The iPhone and iPad app shares the same CloudKit data, but carries connections, groups, and tags only.
