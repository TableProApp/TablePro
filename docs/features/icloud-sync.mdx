---
title: iCloud Sync
description: Sync connections, groups, and tags to your Macs, iPhone, and iPad, and settings, table favorites, and SSH profiles between Macs
---
...
| **Settings** | Yes | Between Macs only. General, Appearance, Editor, Data Grid, History, Tabs, Keyboard, and AI settings, plus custom AI slash commands and saved per-table column widths and order |
...
| **Connection list order** | No | Recent connections and whether that section is shown, the sort order, and the order of favorites stay on each device |
