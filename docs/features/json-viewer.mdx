...
For whole-row JSON across a result set, switch the results pane to its JSON view mode with the switcher above the result, or from **View > Result View**. Table tabs show Data / Structure / JSON; query tabs show Data / JSON.
