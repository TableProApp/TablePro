...
<Frame caption="An SVG logo in a text column, with its markup a segment away">
  <img className="block dark:hidden" src="/images/cell-image-viewer.png" alt="Popover showing a rendered SVG logo above a checkerboard, with Image and Source segments" />
  <img className="hidden dark:block" src="/images/cell-image-viewer-dark.png" alt="Popover showing a rendered SVG logo above a checkerboard, with Image and Source segments" />
</Frame>
