...
- **Tree**: collapsible tree with a search field. Search matches keys and values, opens each matching path, and restores your previous expansion state when cleared. Read-only navigation.
