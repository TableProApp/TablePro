...
A server reaches nothing until a connection allowlists it. Open the connection's edit form, pick **Options**, and tick the servers this connection's sessions may use. A connection with none ticked has no outside tools.
