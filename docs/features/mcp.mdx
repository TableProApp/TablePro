...
- Tool calls never change what's open in the app: `list_tables`, `list_schemas`, and `execute_query` query the database or schema you pass them without moving the sidebar's selected database or touching an open tab.
