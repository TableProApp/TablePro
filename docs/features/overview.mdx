...
<CardGroup cols={2}>
  ...
  <Card title="Data Files" icon="file-csv" href="/features/data-files">
    Filter, clean up and save CSV, JSON and Excel files without importing them.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Connection Window" icon="window-maximize" href="/features/connection-window">
    The toolbar, the Actions menu, and the trailing pane.
  </Card>
