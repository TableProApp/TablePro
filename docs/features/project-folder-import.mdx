...
Each set of credentials found in the folder you pick becomes one row, showing the file and key behind it. Nothing is saved or connected until you review the filled-in form and click **Save**. The scan goes four levels deep and ignores `node_modules`, `.git`, `vendor`, similar directories, and any file over 1 MB.
...
- **Open Project Folder…**, in the welcome window's **Add from Existing** menu
- **Add from Existing > Open Project Folder…** on the welcome window
