...
Recent queries also appear in the [Quick Switcher](/features/quick-switcher). For a summary of what this history adds up to, rather than a list of it, see [Query Insights](/features/query-insights).
