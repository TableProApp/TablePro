...
The results panel expands itself when a query runs. The editor's trash button clears the query and the results together; to keep the query, right-click the results and choose **Clear Results**.
