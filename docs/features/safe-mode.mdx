...
Some engines run read queries and nothing else. [Cloudflare R2 SQL](/databases/cloudflare-r2-sql) is one: its connections are pinned to **Read-Only** and the Safe Mode picker in the connection form is disabled.
