...
A ribbon in the gutter marks every region that spans more than one line: whole statements, table bodies, CTEs, subqueries, `BEGIN` blocks, and block comments. Click a marker to collapse the region, click it again to expand.
