...
Turn folding off in **Settings > Editor**. It also works on the DDL and trigger views, the SQL import preview, the AI review sheet, AI chat code blocks, and the JSON cell viewer.
