...
A privilege you select, a password you set, an account you drop: all of it stages locally, and none of it reaches the server until you open the review sheet, read the exact `GRANT` and `REVOKE` statements, and press **Execute**.
