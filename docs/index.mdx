---
title: Introduction
description: Native macOS database client for MySQL, PostgreSQL, SQLite, MongoDB, Redis, and 31 more
---
...
<CardGroup cols={3}>
  <Card title="Install it" icon="download" href="/installation">
    Homebrew or the DMG, on macOS 14.4 and later.
  </Card>
...
From MySQL and PostgreSQL to DynamoDB, Spanner and Redis, each engine has its own page.
