---
title: Installation
description: Install TablePro via Homebrew or DMG on macOS 14.4+
---
...
New versions download in the background and install when you quit TablePro. Force a check with **TablePro > Check for Updates…**, which always offers the newest build. Two switches in **Settings > General** turn the daily check and the automatic install off. Connections and settings survive an update.
