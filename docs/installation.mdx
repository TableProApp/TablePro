...
New versions download in the background and install when you quit TablePro. Force a check with **TablePro > Check for Updates…**, which always offers the newest build. **Settings > General** turns automatic installs off and sets the check to daily or weekly. Connections and settings survive an update.
