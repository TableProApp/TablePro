...
description: Browse tables, run queries, and edit rows on nine database engines from a synced connection list
---
...
Every driver is compiled in, so there is no plugin system and nothing to install. The type picker offers these nine:
