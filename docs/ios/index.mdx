...
Favorites come first, then **Recent** with the five connections opened last, then your groups, nested the way the Mac nests them. The **More** menu holds **Sort By** (**Manual**, **Name**, **Database Type**, **Last Connected**), **Filter by Tag**, group and tag management, and import and export. Typing a tag's name in the search field offers it as a filter.
