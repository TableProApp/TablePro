...
<Steps>
  <Step title="Install TablePro">
    `brew install --cask tablepro`, or the DMG from GitHub Releases. See [Installation](/installation). The first launch shows a welcome sheet; click **Continue** to reach the welcome window, and choose **Help > Welcome to TablePro** to see it again.
  </Step>
