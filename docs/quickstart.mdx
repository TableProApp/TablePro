...
You can finish this page without a database server. With no connections saved yet, the welcome window offers **Try Sample Database**, which opens a bundled Chinook SQLite file and puts you at step 4. Otherwise start at step 1.
...
- With no connections saved yet, the right panel offers **Try Sample Database**. It opens the bundled Chinook SQLite database, no server needed. Reset it any time from **Help > Reset Sample Database…**.
